...
{
    public partial class RM_Family_PDF : System.Web.UI.Page
    {
        SqlConnection conn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmd = conn.CreateCommand();
            cmd.CommandText = "select invsum.CLILENTCODE as ClientCode,ccm.FamilyCode as Family,ccm.ClientName as ClientName,ccm.branch as Branch,invsum.CASH as Equity,invsum.FNO,invsum.PMS,invsum.MF,invsum.FD from  INVESTMENTSUMMARY invsum,ClientMaster ccm where IS_date='" + date1 + "' and ccm.FamilyCode= '" + familycode1 + "'  and invsum.CLILENTCODE=ccm.ClientCode     order by ccm.FamilyCode desc";
        ...
        //        StringReader sr = new StringReader("<center> <table cellspacing='0' rules='all'  ><tr ><td style=' text-align: center;font-size: 20px' >TRADENET STOCK BROKING PVT LTD,KOLHAPUR</td></tr><td style=' text-align: center;font-size: 15px' >Indicative Familywise Segmentwise Summary Report<sup><b>*</b></sup></td></tr><tr><td style=' text-align: center;' >Client Name:-" + groupleader.ToUpper() + "</td></tr></table></center></br></br> " + sw.ToString() + "</br><table cellspacing='0' rules='all'  ><tr ><td style=' text-align: right;border-style: solid; border-width: 1px' > <b> FAMILY TOTAL:   " + familytotal + "</b></td></tr><tr><td  style=' text-align: right;' ><sup>*</sup>As on Date:- " + date1.ToString("dd-MMM-yyyy") + "</td></tr></table></br><b>Disclaimer:-</b><p style='font-size: 10px'> MF Valuation includes minor applicants valuation also.</p><p style='font-size: 10px' >This report is for information and should not construed as final investment summary for legal and taxation purpose.</p><p style='font-size: 10px'>Please check out individual balances from various segments before acting on this report.</p><p style='font-size: 10px'>Tradenet will not be responsible for any lapses that may occur because of error in this report.</p>");
        //        Document pdfDoc = new Document(PageSize.A3, 10f, 10f, 10f, 0f);
        //        string imageFilePath = Server.MapPath(".") + @"\pdf_logo.jpg";
        //        iTextSharp.text.Image jpg = iTextSharp.text.Image.GetInstance(imageFilePath);
